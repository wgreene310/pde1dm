...
%         of the P-by-Q matrices in A by the R-by-S matrices in B. [DA1 DA2] are
%         the IDs of A; [DB1 DB2] are the IDs of B.
%
%   2) 2-D by 1-D BLOCK(S) (*)
%         C = MULTIPROD(A, B, [DA1 DA2], DB1) contains the products of the
%         P-by-Q matrices in A by the R-element vectors in B. The latter are
%         considered to be R-by-1 matrices. [DA1 DA2] are the IDs of A; DB1 is
%         the ID of B.
%
%   3) 1-D by 2-D BLOCK(S) (*)
%         C = MULTIPROD(A, B, DA1, [DB1 DB2]) contains the products of the 
%         Q-element vectors in A by the R-by-S matrices in B. The vectors in A
%         are considered to be 1-by-Q matrices. DA1 is the ID of A; [DB1 DB2]
%         are the IDs of B.
%
...
%             contained in A and B into 1-by-P and P-by-1 matrices, respectively,
...
%             contained in A and B into P-by-1 and 1-by-Q matrices, respectively,
...
%      1) C contains P-by-S matrices along IDs MAX([DA1 DA2], [DB1 DB2]).
%      2) Array     Block size     ID(s)
%         ----------------------------------------------------
%         A         P-by-Q  (2-D)     [DA1 DA2]
%         B         R    (1-D)     DB1
%         C (a)     P    (1-D)     MAX(DA1, DB1)
%         C (b)     P-by-Q  (2-D)     MAX([DA1 DA2], [DB1 DB1+1])
%         ----------------------------------------------------
...
%         ----------------------------------------------------
%         A           Q  (1-D)     DA1
%         B         R-by-S  (2-D)     [DB1 DB2]
%         C (a)       S  (1-D)     MAX(DA1, DB1)
%         C (b)     R-by-S  (2-D)     MAX([DA1 DA1+1], [DB1 DB2])
%         ----------------------------------------------------
...
%         (c) A         P        (1-D)     DA1
%             B         Q        (1-D)     DB1
%             C         P-by-Q      (2-D)     MAX([DA1 DA1+1], [DB1 DB1+1])
%         --------------------------------------------------------------
%
...
%
%   Examples:
%    1) If  A is .................... a 5-by-(6-by-3)-by-2 array,
%       and B is .................... a 5-by-(3-by-4)-by-2 array,
%       C = MULTIPROD(A, B, [2 3]) is a 5-by-(6-by-4)-by-2 array.
%
%       A single matrix A pre-multiplies each matrix in B
%       If  A is ........................... a (1-by-3)    single matrix,
%       and B is ........................... a 10-by-(3-by-4) 3-D array,
%       C = MULTIPROD(A, B, [1 2], [3 4]) is a 10-by-(1-by-4) 3-D array.
%
%       Each matrix in A pre-multiplies each matrix in B (all possible
%       combinations)
%       If  A is .................... a (6-by-3)-by-5   array,
%       and B is .................... a (3-by-4)-by-1-by-2 array,
%       C = MULTIPROD(A, B, [1 2]) is a (6-by-4)-by-5-by-2 array.
%
%   2a) If  A is ........................... a 5-by-(6-by-3)-by-2 4-D array,
%       and B is ........................... a 5-by-(3)-by-2   3-D array,
%       C = MULTIPROD(A, B, [2 3], [2]) is   a 5-by-(6)-by-2   3-D array.
%
%   2b) If  A is ........................... a 5-by-(6-by-3)-by-2 4-D array,
%       and B is ........................... a 5-by-(1)-by-2   3-D array,
%       C = MULTIPROD(A, B, [2 3], [2]) is   a 5-by-(6-by-3)-by-2 4-D array.
%
%   4a) If both A and B are .................. 5-by-(6)-by-2   3-D arrays,
%       C = MULTIPROD(A, B, 2) is .......... a 5-by-(1)-by-2   3-D array, while
%   4b) C = MULTIPROD(A, B, [2 0], [0 2]) is a 5-by-(6-by-6)-by-2 4-D array
%
...
%   Example: If the size of A is .......... 5-by-(6-by-3)
%            NEWSIZE = SWAPIDS(SIZE0, 2) is 5-by-(3-by-6)
